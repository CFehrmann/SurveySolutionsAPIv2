...
- **suso_mapupload, suso_mapassign, suso_maps, suso_mapreport** and **suso_deletemap** now also enable complete map management with a single package, and the same syntax/outputs[^2].
